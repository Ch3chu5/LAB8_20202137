...
public class peliculaDao extends baseDao{
    ...
    public void editarPelicula(String genero, String streaming ,int idPelicula, String titulo, String director, int anoPublicacion, double rating, double boxOffice){
        try {
            String url = "jdbc:mysql://localhost:3306/mydb?serverTimezone=America/Lima";
            String username = "root";
            String password = "root";
